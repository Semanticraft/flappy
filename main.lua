...
function love.load()
    ...
    sounds = {
        ...
        ['pause'] = love.audio.newSource('sounds/pause-resume.wav', 'static'),
...
function love.update(dt)
    ...
    backgroundScroll = scrolling and (backgroundScroll + BACKGROUND_SCROLL_SPEED * dt) % BACKGROUND_LOOPING_POINT or
        backgroundScroll
